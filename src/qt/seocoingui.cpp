...
#ifndef Q_OS_MAC
    qApp->setWindowIcon(QIcon(":icons/seocoin"));
    setWindowIcon(QIcon(":icons/seocoin"));
#else
...
void FreicoinGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/seocoin"), tr("&About Freicoin"), this);
    ...
    toggleHideAction = new QAction(QIcon(":/icons/seocoin"), tr("Show / &Hide"), this);
...
#ifndef Q_OS_MAC
            qApp->setWindowIcon(QIcon(":icons/seocoin_testnet"));
            setWindowIcon(QIcon(":icons/seocoin_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/seocoin_testnet"));
#endif
            if(trayIcon)
            {
